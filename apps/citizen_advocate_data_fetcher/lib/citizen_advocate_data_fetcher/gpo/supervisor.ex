defmodule CitizenAdvocateDataFetcher.GPO.Supervisor do
  use Supervisor
  ...
  defp poolboy_fetcher_spec do
    poolboy_config = Application.get_env(:citizen_advocate_data_fetcher, :pools)[:gpo_fetchers]

    :poolboy.child_spec(:gpo_fetchers, poolboy_config, [])
  end

  defp poolboy_parser_spec do
    poolboy_config = Application.get_env(:citizen_advocate_data_fetcher, :pools)[:gpo_parsers]
