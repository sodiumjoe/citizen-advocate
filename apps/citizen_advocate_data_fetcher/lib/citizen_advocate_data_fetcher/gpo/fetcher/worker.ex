defmodule CitizenAdvocateDataFetcher.GPO.Fetcher.Worker do
  use GenServer

  @http Application.get_env(:citizen_advocate_data_fetcher, :gpo)[:http_client] || HTTPoison
  @file_module Application.get_env(:citizen_advocate_data_fetcher, :gpo)[:file_module] || File
  @sys_module Application.get_env(:citizen_advocate_data_fetcher, :gpo)[:sys_module] || System
  @tmp_dir Application.get_env(:citizen_advocate_data_fetcher, :tmp_dir)
