defmodule CitizenAdvocateDataFetcher.Propublica.Supervisor do
  use Supervisor
  ...
  defp poolboy_fetcher_spec do
    poolboy_config = Application.get_env(:citizen_advocate_data_fetcher, :pools)[:propublica_fetchers]
