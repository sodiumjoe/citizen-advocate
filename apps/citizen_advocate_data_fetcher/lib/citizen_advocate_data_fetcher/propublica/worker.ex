defmodule CitizenAdvocateDataFetcher.Propublica.Worker do
  use GenServer

  @http Application.get_env(:citizen_advocate_data_fetcher, :propublica)[:http_client] || HTTPoison
  @api_key Application.get_env(:citizen_advocate_data_fetcher, :propublica)[:api_key] 
